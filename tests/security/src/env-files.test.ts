...
describe('env-files: agent file-tool denial', () => {
  it.todo(
    'Claude Code Read tool is denied for .env files when keynv-guard hook is installed',
  );
  ...
  it.todo(
    'OpenCode integration prevents file tools from reading .env (mechanism TBD by Phase 2)',
  );
