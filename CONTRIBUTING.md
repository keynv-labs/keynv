...
- Read [`AGENTS.md`](./AGENTS.md) for the project rules. They apply to humans too — the file is named for the AI agent we use day-to-day, but the rules cover anyone touching the code.
